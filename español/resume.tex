...
\begin{document}
	...
	\begin{rSection}{Experiencia Laboral}
		\begin{rSubsection}{Geocuba}{enero 2021 - presente}{Programador Backend}{}
	...
	\begin{rSection}{Habilidades}
		...
		\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
			Lenguajes de programación \ & Java, Kotlin, JavaScript, TypeScript, Python, C, HTML5, CSS  \\
