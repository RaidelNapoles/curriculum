...
\begin{document}
	...
	\begin{rSection}{Work experience}
		\begin{rSubsection}{Geocuba}{January 2021 - present}{Backend Developer}{}
	...
	\begin{rSection}{Skills}
		\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
		Programming Languages \ & Java, Kotlin, JavaScript, TypeScript, Python, C, HTML5, CSS  \\
		Frameworks & Express, Node.js, NestJs, Django \\
	...
	\begin{rSection}{Language Skills}
		\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
			...
			Other language(s) & English (A2 level)
		\end{tabular}
	\end{rSection}
